...
<html>
	<head>
		<title>sakoju nsfw Dashboard</title>
  ...
  <body>
  	<div class ='a'>
							<div class="links">
								<h2><font color='pink'>
                  <br><a href="dashboard" target="_blank"><button type="submit" class="btn btn-primary btn-block btn-large">Return To Main Dashboard</a></button><br>
                  <br><a href="homepage" target="_blank"><button type="submit" class="btn btn-primary btn-block btn-large">Return To Homepage</a></button><br>
                ...
                <p><a href="https://c-chikara.herokuapp.com"><button type="submit" class="btn btn-primary btn-block btn-large">C-chikara dApp</button></a></p><br> 
              <p><a href="https://keiyakusho.herokuapp.com"><button type="submit" class="btn btn-primary btn-block btn-large">Keiyakusho dApp</button></a></p><br> 
                ...
                <h4 class="text-center font-weight-bold">sakujo NSFW Image Upload</h4>
